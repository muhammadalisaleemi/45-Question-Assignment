{
  ...
  let personName1: string = "Gujjar Sb";
  console.log(
    `Hello ${personName1}, would you like to learn some Python today?`
  );
}
...

{
  ...
  let famous_person1: string = "Andrew Tate";
  let message2: string =
...
let names: string[] = ["Ali", "Khan", "Usman", "Sohail"];
...
const transportation: string[] = ["Honda 125", "Mehran", "GTR", "F1"];
...
const guest1: string[] = ["Arham", "Saad", "Yaseen"];

for (const guest of guest1) {
  console.log(
    `Dear ${guest}, I would like to invite you to dinner at my place.`
  );
}
...
console.log(
  `Dear ${guest1[1]}, I would like to invite you to dinner at my place.  `
);
...
console.log(
  `Dear ${guest1[5]}, I'm sorry to inform you that I can't invite you to dinner.`
);
guest1.pop();
console.log(
  `Dear ${guest1[4]}, I'm sorry to inform you that I can't invite you to dinner.`
);
guest1.pop();
console.log(
  `Dear ${guest1[3]}, I'm sorry to inform you that I can't invite you to dinner.`
);
guest1.pop();
console.log(
  `Dear ${guest1[2]}, I'm sorry to inform you that I can't invite you to dinner.`
);
guest1.pop();
...
let sortedplaces: string[] = [...places].sort();
console.log(places);
...
let reverseplaces: string[] = [...sortedplaces.reverse()];
...
let countries: string[] = ["Pakistan", "India", "America"];
...
//Intentional Error:
const countries1: string[] = ["Pakistan", "India", "America"];
...
var alien_color1: string = "green";

if (alien_color1 == "green") {
  console.log("player just earned 5 points");
}

var alien_color2: string = "green";
...
var alien_color3: string = "green";

if (alien_color3 == "green") {
  console.log("player just earned 5 points.");
}
//
var alien_color3: string = "red";
...
const userNames7: string[] = ["admin", "saleem", "ali", "saad", "sohail"];
...
const current_users: string[] = ["admin", "saleem", "Ali", "saad", "sohail"];
const new_users: string[] = ["Naveed", "Ali", "Huzaifa", "Sombal", "Ayesha"];
...
const numbers5: number[] = [1, 2, 3, 4, 5, 6, 7, 8, 9];
...
const pizzas: string[] = ["Marinara", "Capricciosa", "Pepperoni"];
...
const animals: string[] = ["car", "dog", "mouse"];
...
function make_shirt1(size: string, text: string) {
  console.log(
    `The shirt is size ${size} and has the message '${text}' printed on it.`
  );
}
...
function make_shirt2(size: string = "L", text: string = "I hate you") {
  console.log(
    `The shirt is size ${size} and has the message '${text}' printed on it.`
  );
}
...
const magicians1: string[] = ["Baldwin, Samri", "Archer, John", "Bavli, Guy"];
...
let magicians2: string[] = ["Baldwin, Samri", "Archer, John", "Bavli, Guy"];
...
const magicians3: string[] = ["Baldwin, Samri", "Archer, John", "Bavli, Guy"];

function show_magicians(magicians3: string[]): void {
  for (const magician of magicians3) {
    console.log(magician);
  }
}

function make_great(magicians3: string[]): string[] {
